        ...
        <div class="side-menu-content p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <button class="btn ms-1" @click="toggleMenu">
                    <img :src="isOpen ? '/iconos/angulo-derecho.svg' : '/iconos/menu-hamburguesa.svg'" alt="Toggle"
                        width="18" height="18" :class="{ 'rotate-icon': isOpen }">
                </button>
            </div>
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="#" @click.prevent="toggleSubmenu('usuarios')"
                        ...
                        <img v-if="isOpen" src="/iconos/angulo-derecho.svg"
                            :class="{ 'submenu-icon-rotated': submenuStates.usuarios }" class="submenu-icon ms-auto"
                            width="12" height="12">
                    </a>
                    <ul class="submenu" v-show="submenuStates.usuarios && isOpen">
                        <li>
                            <router-link class="nav-link submenu-link" to="/usuarios/pacientes"
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="#" @click.prevent="toggleSubmenu('citas')">
                        ...
                        <img v-if="isOpen" src="/iconos/angulo-derecho.svg"
                            :class="{ 'submenu-icon-rotated': submenuStates.citas }" class="submenu-icon ms-auto"
                            width="12" height="12">
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="#" @click.prevent="toggleSubmenu('emergencia')">
                        ...
                        <img v-if="isOpen" src="/iconos/angulo-derecho.svg"
                            :class="{ 'submenu-icon-rotated': submenuStates.emergencia }" class="submenu-icon ms-auto"
                            width="12" height="12">
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="#" @click.prevent="toggleSubmenu('farmacia')">
                        ...
                        <img v-if="isOpen" src="/iconos/angulo-derecho.svg"
                            :class="{ 'submenu-icon-rotated': submenuStates.farmacia }" class="submenu-icon ms-auto"
                            width="12" height="12">
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="#" @click.prevent="toggleSubmenu('almacen')">
                        ...
                        <img v-if="isOpen" src="/iconos/angulo-derecho.svg"
                            :class="{ 'submenu-icon-rotated': submenuStates.almacen }" class="submenu-icon ms-auto"
                            width="12" height="12">
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="#">
                        <img src="/iconos/factura-punto-de-venta.svg" alt="Citas" width="17" height="17"
                            class="iconColor">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="#">
                        <img src="/iconos/mano-sosteniendo-usd.svg" alt="Citas" width="17" height="17"
                            class="iconColor">
...
.side-menu-minimized {
    width: 80px;
    /* Ancho del side menu minimizado */
}
